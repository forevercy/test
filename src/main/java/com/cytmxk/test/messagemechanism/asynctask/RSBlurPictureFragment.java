...
public class RSBlurPictureFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_rs_blur, container,
				false);
		mIvShowBeauty = (ImageView) view.findViewById(R.id.show_beauty);
		AsyncTaskUtil.getRSBlurPicture(getActivity(), BitmapFactory
